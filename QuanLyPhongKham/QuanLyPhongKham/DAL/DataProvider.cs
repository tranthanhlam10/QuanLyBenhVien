...
namespace QuanLyPhongKham.DAL
{
    public class DataProvider
    {
        ...
        {
            string connectionStrType = String.Format(@"Data Source = DESKTOP-9OUV00A; Initial Catalog = QLPhongKham; Integrated Security = True", Environment.MachineName);
            ...
            {
                connectionStrType = String.Format(@"Data Source = DESKTOP-9OUV00A; Initial Catalog = QLPhongKham; Integrated Security = True", Environment.MachineName);
