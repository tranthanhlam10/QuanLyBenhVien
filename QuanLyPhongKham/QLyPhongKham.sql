...
create table GiayXetNghiem
(
MaPKB varchar(10) primary key not null,
MaBN varchar(10) foreign key references BenhNhan(MaBN) not null,
MaNV varchar(10) foreign key references NhanVien(MaNV) not null,
NgXetNghiem datetime not null,
LoaiXetNghiem varchar(50),
Ketqua varchar(1000),

)


create table GiayHenNhapVien
(
...
-- load dữ liệu về bệnh nhân lên dgv bệnh viện
select MaPKB,GiayXetNghiem.MaBN as 'Mã Bệnh Nhân' ,TenBN as 'Tên Bệnh Nhân',GiayXetNghiem.MaNV as 'Mã Nhân viên',NgXetNghiem,LoaiXetNghiem,KetQua from GiayXetNghiem, BenhNhan, NhanVien
where GiayXetNghiem.MaBN=BenhNhan.MaBN and GiayXetNghiem.MaNV = NhanVien.MaNV

-- load dữ liệu về giấy hẹn nhập viện lên dvg

select MaGH, GiayHenNhapVien.MaBN, BenhNhan.TenBN ,GiayHenNhapVien.MaNV, NgNhapVen, SoPhong, GhiChu from GiayHenNhapVien, BenhNhan, NhanVien 
where GiayHenNhapVien.MaBN = BenhNhan.MaBN and GiayHenNhapVien.MaNV = NhanVien.MaNV

insert into GiayXetNghiem values ('GXN001', 'BN001', 'BS001',CAST(N'2020-03-01T00:00:00.000' AS DateTime),' Xet nghiem toan bo',' Ung thu mau')


insert into GiayHenNhapVien values ('GHNV01' , 'BN001', 'BS001', CAST(N'2020-03-01T00:00:00.000' AS DateTime), '1', 'Khong')
	insert into GiayHenNhapVien values ('GHNV02' , 'BN001', 'BS001', CAST(N'2020-03-01T00:00:00.000' AS DateTime), '2', 'Khong')

Delete from PKB Where MaBN = 'BN001'
